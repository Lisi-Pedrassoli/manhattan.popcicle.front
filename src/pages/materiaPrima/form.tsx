          ...
          <form onSubmit={handleSubmit(id ? () => atualizarMateriaPrima() : () => criarMateriaPrima())} className="px-5 space-y-3">
            ...
            <label className="flex flex-col">
              ...
              <select {...register("unidadeMedida", { required: true })} className="input w-full">
                <option value="QUILOGRAMA_KG">Quilograma</option>
                <option value="GRAMA_G">Grama</option>
                <option value="TONELADA_T">Tonelada</option>
                <option value="LITRO_L">Litro</option>
                <option value="MILILITRO_ML">Mililitro</option>
                <option value="UNIDADE_UN">Unidade</option>
                <option value="METRO_M">Metro</option>
                <option value="CENTIMETRO_CM">Centímetro</option>
                <option value="PACOTE_PCT">Pacote</option>
              </select>
            </label>
